          ...
          <el-col class="item-value">
            ...
            :headers="headers"
             ...
             :on-progress="uploadVideoProcess">
                <video v-if="videoLink !='' && videoFlag == false" :src="videoLink" class="avatar" crossorigin="anonymous" controls="controls">您的浏览器不支持视频播放</video>
                <i v-else-if="videoLink=='' && videoFlag == false" class="el-icon-plus avatar-uploader-icon"></i>
      ...
      <el-row class="setting-item" type="flex" align="middle" v-if="isSwitch">
        ...
        <el-col class="item-value">
          <el-upload class="img-uploader"
            ...
            <img  :src="imageUrl&&(imageUrl)||'/static/img/blank.png'" class="img-preview"/>         
          </el-upload>
        </el-col>
      </el-row>
