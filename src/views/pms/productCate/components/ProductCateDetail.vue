...
<script>
  ...
  export default {
    ...
    mounted:function(){
      if(this.isEdit) {
        if(this.$route.query.id){
              ...
              sessionStorage.setItem('ProductCateDetailid',this.$route.query.id);
        }
      }
    },
    ...
    watch: {
        $route(){
           if(this.isEdit){
                if(this.$route.path=='/pms/updateProductCate' && this.$route.query.id){
                  var newid = this.$route.query.id;//当前页新id
                  var oldid = sessionStorage.getItem('ProductCateDetailid');//旧的id
              ...
              if (this.isEdit) {
                ...
                updateProductCate(this.$route.query.id, this.productCate).then(response => {
                  this.$message({
                   ...
                   this.resetData();
                   sessionStorage.removeItem('ProductCateDetailid')
                  this.$router.back();
