...
<script>
  ...
  export default {
     ...
     mounted:function(){
      if(this.isEdit) {
        if(this.$route.query.id){
              ...
              sessionStorage.setItem('updateBrandid',this.$route.query.id);
        }
      }
    },
    ...
    watch: {
        $route(){
           if(this.isEdit){
                if(this.$route.path=='/pms/updateBrand' && this.$route.query.id){
                  var newid = this.$route.query.id;//当前页新id
                  var oldid = sessionStorage.getItem('updateBrandid');//旧的id
              ...
              if (this.isEdit) {
                updateBrand(this.$route.query.id, this.brand).then(response => {
                  ...
                  this.$message({
                   ...
                   this.resetData();
                    sessionStorage.removeItem('updateBrandid')
                  this.$router.back();
