      ...
      if(this.isEdit) {
        if(this.$route.query.id){
          console.log('---');
              ...
              sessionStorage.setItem('updateProductAttrid',this.$route.query.id);
        }
      }
    },
    ...
    watch:{
      ...
      inputListFormat: function (newValue, oldValue) {
       ...
       $route(){
           ...
           if(this.isEdit){
                if(this.$route.path=='/pms/updateProductAttr' && this.$route.query.id){
                  var newid = this.$route.query.id;//当前页新id
                  var oldid = sessionStorage.getItem('updateProductAttrid');//旧的id
            ...
            this.$confirm('是否提交数据', '提示', {
              ...
              if(this.isEdit){
                updateProductAttr(this.$route.query.id,this.productAttr).then(response=>{
                  ...
                  this.resetData();
                  sessionStorage.removeItem('updateProductAttrid')
                  this.$router.back();
                });
              }else{
