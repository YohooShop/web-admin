<template> 
  <div class="app-container">
    ...
    <logistics-dialog v-model="logisticsDialogVisible" ref="logistics"></logistics-dialog>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleDeliveryOrder(index, row){
        ...
        this.$router.push({path:'/oms/deliverOrderList',query:{list:JSON.stringify([listItem])}})
      },
      handleViewLogistics(index, row){
         this.$refs.logistics.express(row.orderSn,row.deliverySn,row.deliveryCode);
      ...
      handleBatchOperate(){
        ...
        if(this.operateType===1){
          ...
          this.$router.push({path:'/oms/deliverOrderList',query:{list:JSON.stringify(list)}})
      ...
      covertOrder(order){
        ...
        let listItem={
          ...
          senderRegion:order.senderRegion,
