      ...
      <el-row class="setting-item" type="flex" align="middle"  v-if="extra.needShare">
        ...
        <el-col class="item-value">
          <el-upload class="img-uploader"
            ...
            <img  :src="extra.shareImage&&(extra.shareImage)||'/static/img/blank.png'" class="share-image"/>          
          </el-upload>
      ...
      <el-row class="setting-item" type="flex" align="middle"  v-if="extra.needBackTop">
        ...
        <el-col class="item-value">
          <el-upload class="img-uploader"
            ...
            <img  :src="extra.backTopImage&&(extra.backTopImage)||'/static/img/blank.png'" class="backtop-image"/>          
          </el-upload>
        </el-col>
      </el-row>          
    </div>
...
//动态组件引入
import CarouselSet from '@/components/ui/CarouselSet'
import EventSet from '@/components/ui/EventSet'
import GoodsSet from '@/components/ui/GoodsSet'
import PictureSet from '@/components/ui/PictureSet'
import VideoSet from '@/components/ui/VideoSet'
import IndexBannerSet from "@/components/ui/IndexBannerSet"
import IndexGroupingSet from "@/components/ui/IndexGroupingSet"
import IndexSearchSet from "@/components/ui/IndexSearchSet"
import IndexNavSet from "@/components/ui/IndexNavSet"
import IndexCubeSet from "@/components/ui/IndexCubeSet"
import IndexCouponSet from "@/components/ui/IndexCouponSet"
import IndexCategorySet from "@/components/ui/IndexCategorySet"
import IndexSubjectSet from "@/components/ui/IndexSubjectSet"
import IndexSeckillSet from "@/components/ui/IndexSeckillSet"
import IndexGrouponSet from "@/components/ui/IndexGrouponSet"
...
export default {
  ...
  methods:{
    ...
    uploadSuccessShare(res, file){
      this.loading=false
      this.extra.shareImage = res.data.link
    ...
    uploadSuccessBackTop(res, file){
      this.loading=false
      this.extra.backTopImage = res.data.link
