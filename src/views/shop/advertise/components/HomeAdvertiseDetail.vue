<template> 
  <el-card class="form-container" shadow="never">
    <el-form :model="homeAdvertise"
	  ...
	  <el-form-item label="内部页面/外部连接：">
	    <el-radio-group v-model="homeAdvertise.isouterLink">
      ...
      <el-form-item label="广告链接：" prop="url">
        <el-input v-model="homeAdvertise.url" class="input-width"></el-input>
         ...
         <el-form-item label="uniapp路由：" prop="uniappUrl">
        <el-input v-model="homeAdvertise.uniappUrl" class="input-width"></el-input>
      </el-form-item>
       </el-form-item>
         <el-form-item label="mp小程序路由：" prop="mpUrl">
        <el-input v-model="homeAdvertise.mpUrl" class="input-width"></el-input>
      </el-form-item>
    ...
    data() {
      return {
        ...
        rules: {
          ...
          uniappUrl: [
            {required: true, message: '请输入uniapp路由', trigger: 'blur'}
          ],
          mpUrl: [
            {required: true, message: '请输入小程序路由', trigger: 'blur'}
          ],
