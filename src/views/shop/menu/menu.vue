<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column prop="mpUrl" label="mpvue小程序路由" width="140" />
      <el-table-column prop="uniappUrl" label="uniapp路由" />
  ...
  methods: {
    ...
    edit(data) {
      ...
      _this.form = {
        ...
        url: data.url,
        mpUrl: data.mpUrl,
        uniappUrl: data.uniappUrl,
        icon: data.icon,
        imageArr: data.icon ? data.icon.split(',') : [],
        sort: data.sort,
        status: data.status
      }
      _this.dialog = true
