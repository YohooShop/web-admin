  ...
  <div class="app-container">
    <div class="wechat-reply-wrapper wechat-menu">
      ...
      <div class="ibox-content submit">
        ...
        <button class="el-button el-button--primary" @click="doSynchronize">同步</button>
      </div>
...
import { del, add, get ,synchronize} from '@/api/wechat/menu'
...
export default {
  ...
  created() {
    get().then(res => {
      this.menus = JSON.parse(res.data.result)
    })
  },
  methods: {
    checkPermission,
    beforeInit() {
      this.url = 'api/wechat/menu'
      const sort = 'key,desc'
