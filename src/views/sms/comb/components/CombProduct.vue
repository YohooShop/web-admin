   ...
   <div style="margin-top: 50px">
    <el-form ref="form" :model="form" :rules="rules" label-width="120px" style="width: 720px" size="small">
      ...
      <el-form-item label="是否包邮">
        <el-radio v-model="form.postageStatus" :label=true>是</el-radio>
        <el-radio v-model="form.postageStatus" :label=false style="width: 110px;">否</el-radio>
      </el-form-item>
      <el-form-item label="活动状态">
        <el-radio v-model="form.isShow" :label=true>开启</el-radio>
        <el-radio v-model="form.isShow" :label=false style="width: 200px;">关闭</el-radio>
      </el-form-item>

      <el-form-item label="热门状态">
        <el-radio v-model="form.hotStatus" :label=true>开启</el-radio>
        <el-radio v-model="form.hotStatus" :label=false style="width: 200px;">关闭</el-radio>
      </el-form-item>
...
<script>
import { add, update, getinfo } from '@/api/shop/combProduct'
